...
* @constructor
*/
StormControllerFreeCam = function() { 
	this.controllerType = 0; // 0 StormControllerFreeCam
	this.g_forwardFC = 0;
	this.g_backwardFC = 0;
...
* @param event event
*/
StormControllerFreeCam.prototype.keyDownFC = function(event) {
...
* @param event event
*/
StormControllerFreeCam.prototype.keyUpFC = function(event) {
	if (String.fromCharCode(event.keyCode) == "W") {
		this.g_forwardFC = 0;
    }
	if (String.fromCharCode(event.keyCode) == "S") {
...
* @param event event
*/
StormControllerFreeCam.prototype.mouseMoveFC = function(event) {
...
* @param event event
*/
StormControllerFreeCam.prototype.mouseDownFC = function(event) {
...
* @param event event
*/
StormControllerFreeCam.prototype.mouseUpFC = function(event) {
	this.leftButton = 0;
	this.middleButton = 0;
	this.rightButton = 0;
};
...
* @param event event
*/
StormControllerFreeCam.prototype.mouseWheel = function(event) {
...
* @private 
*/
StormControllerFreeCam.prototype.cameraSetupFC = function(cameraNode, meshNode) {
